...
public class ParseStringService {
	...
	public static List<String> parseToListOfStrings(String handOfCards) {
		...
		if(handOfCards.length() != 10) throw new InputParseException(INVALID_CARD_STRING_ERROR_MSG);
	...
	public static List<Card> parseToListOfCards(List<String> listOfString) {
		...
		if( listOfString.size() != 5) throw new InputParseException(INVALID_CARD_STRING_ERROR_MSG);
