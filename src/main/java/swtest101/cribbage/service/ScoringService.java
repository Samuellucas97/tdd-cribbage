...
public class ScoringService {
	...
	public static Integer rule4CardFlushExcludingStarterCard_4Points(int score, List<Card> listOfCards) {
	...
	public static Integer rule5CardFlushIncludingStarterCard_5Points(int score, List<Card> listOfCards) {
	...
	public static Integer ruleJackInTheHandWhoseSuitMatchesTheStarterCardSuit_1Point(int score, List<Card> listOfCards) {
	...
	public static Integer ruleCardValuesThatAddUpTo15_2Points_5Length(int score, List<Card> listOfCards) {
		int summation = 0;
	...
	public static Integer ruleCardValuesThatAddUpTo15_2Points_4Length(int score, List<Card> listOfCards) {
	...
	public static Integer ruleCardValuesThatAddUpTo15_2Points_3Length(int score, List<Card> listOfCards) {
	...
	public static Integer ruleCardValuesThatAddUpTo15_2Points_2Length(int score, List<Card> listOfCards) {
		
		int summation = 0;
		
		Set<Pair<Card,Card>> pares = new HashSet<Pair<Card, Card>>() ;
		
				
		for( Card card_aux : listOfCards){
			
			summation = 0;

			for( Card card : listOfCards){

				System.out.print(card.getRank() + " " + card_aux.getRank());
				if( pares.contains( new Pair<Card, Card> (card, card_aux) ) == false  ) {
				
					pares.add( new Pair<Card, Card> (card, card_aux) );
					pares.add( new Pair<Card, Card> ( card_aux, card ) );
