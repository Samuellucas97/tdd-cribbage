...
public class ScoringServiceTest {
	...
	public void test() {
		...
		assertThat(score, is(equalTo(28)));
	}

	@Test
	public void testRulePairOfCards_2Points_AreSequence() {
		final String handOfCards = "JH5C5H5D5S";
		...
		final Integer score = ScoringService.rulePairOfCards_2Points(0,
				listOfCards);

		assertThat(score, is(equalTo(12)));
	}
	...
	public void testRuleStraightOfThreeCardsOrMore_1PointPerCard_3Cards() {
		...
		final Integer score = ScoringService
				.ruleStraightOfThreeCardsOrMore_1PointPerCard(0, listOfCards);
	...
	public void testRule4CardFlushExcludingStarterCard_4Points() {
		...
		final Integer score = ScoringService
				.rule4CardFlushExcludingStarterCard_4Points(0, listOfCards);
	...
	public void testRule5CardFlushIncludingStarterCard_5Points() {
		...
		final Integer score = ScoringService
				.rule5CardFlushIncludingStarterCard_5Points(0, listOfCards);
	...
	public void testRuleJackInTheHandWhoseSuitMatchesTheStarterCardSuit_1Point() {
		...
		final Integer score = ScoringService
				.ruleJackInTheHandWhoseSuitMatchesTheStarterCardSuit_1Point(0,
						listOfCards);
	...
	public void testRuleCardValuesThatAddUpTo15_2Points_5Length() {
		...
		final Integer score = ScoringService
				.ruleCardValuesThatAddUpTo15_2Points_5Length(0, listOfCards);
	...
	public void testRuleCardValuesThatAddUpTo15_2Points_4Length() {
		...
		final Integer score = ScoringService
				.ruleCardValuesThatAddUpTo15_2Points_4Length(0, listOfCards);
	...
	public void testRuleCardValuesThatAddUpTo15_2Points_3Length() {
		final String handOfCards = "7CJH9SAH4D";
		...
		final Integer score = ScoringService
				.ruleCardValuesThatAddUpTo15_2Points_3Length(0, listOfCards);
	...
	public void testRuleCardValuesThatAddUpTo15_2Points_2Length() {
		...
		final Integer score = ScoringService
				.ruleCardValuesThatAddUpTo15_2Points_2Length(0, listOfCards);
